# ruby spectra_counts_summary_tables_filtered.rb ../results/phospho_soft_stiff_b1_b2_summaries_filtered_for1counts.csv
...
results_wb.add_worksheet(:name => "soft-stiff") do |sheet|
	...
	condition1_common_mod_pep_hits.each_key do |peptide|
		...
		if condition1_common_mod_pep_hits[peptide][2].to_i > 1 && !condition1_common_mod_pep_hits[peptide][2].nil?
			all_conditions_mod_pep_hits[peptide][2] = condition1_common_mod_pep_hits[peptide][2] #count
		end
		if condition2_common_mod_pep_hits[peptide][2].to_i > 1 && !condition2_common_mod_pep_hits[peptide][2].nil?
			all_conditions_mod_pep_hits[peptide][3] = condition2_common_mod_pep_hits[peptide][2] #count
		end
		if condition3_common_mod_pep_hits[peptide][2].to_i > 1 && !condition3_common_mod_pep_hits[peptide][2].nil?
			all_conditions_mod_pep_hits[peptide][4] = condition3_common_mod_pep_hits[peptide][2] #count
		end
		if condition4_common_mod_pep_hits[peptide][2].to_i > 1 && !condition4_common_mod_pep_hits[peptide][2].nil?
...
results_wb.add_worksheet(:name => "soft-only") do |sheet|
	...
	condition1_only_mod_pep_hits.each_key do |peptide|
		if condition1_only_mod_pep_hits[peptide][2]>1
	...
	condition3_only_mod_pep_hits.each_key do |peptide|
		if condition3_only_mod_pep_hits[peptide][2]>1
...
results_wb.add_worksheet(:name => "stiff-only") do |sheet|
	...
	condition2_only_mod_pep_hits.each_key do |peptide|
		if condition2_only_mod_pep_hits[peptide][2]>1
	...
	condition4_only_mod_pep_hits.each_key do |peptide|
		if condition4_only_mod_pep_hits[peptide][2]>1
