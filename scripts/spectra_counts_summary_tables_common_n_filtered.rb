# ruby spectra_counts_summary_tables_common_n_filtered.rb ../results/phospho_soft_stiff_b1_b2_summaries_shortened_.csv
...
results_wb.add_worksheet(:name => "soft-stiff") do |sheet|
	...
	condition1_common_mod_pep_hits.each_key do |peptide|
		if condition1_common_mod_pep_hits[peptide][2].to_i > 2 && condition2_common_mod_pep_hits[peptide][2].to_i > 2 && condition3_common_mod_pep_hits[peptide][2].to_i > 2 && condition4_common_mod_pep_hits[peptide][2].to_i > 2
			
			accnos = [condition1_common_mod_pep_hits[peptide][0], condition2_common_mod_pep_hits[peptide][0], condition3_common_mod_pep_hits[peptide][0], condition4_common_mod_pep_hits[peptide][0]]
			accnos.uniq!
